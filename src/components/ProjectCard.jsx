...
const ProjectCard = ({ project, index }) => {
  ...
  ref={ref}
  style={{ scale, opacity }}
  className={`group relative bg-gray-100 dark:bg-white/10 border border-black/5 dark:border-white/20 rounded-lg overflow-visible sm:min-h-[24rem] sm:max-w-[42rem] mx-auto mb-12 hover:bg-gray-200 transition-all duration-300 ease-out`}
>
  {/* Text Section */}
  <div
